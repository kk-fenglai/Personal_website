...
> = {
  zh: {
    ...
    "admin.dragDropHint": "拖拽图片到此处，或点击选择",
    "admin.formTitle": "标题",
  ...
  en: {
    ...
    "admin.dragDropHint": "Drag and drop here, or click to choose",
  ...
  fr: {
    ...
    "admin.dragDropHint": "Glissez-déposez une image ici ou cliquez pour choisir",
