...
> = {
  zh: {
    ...
    "admin.visitsDevice": "设备 / 机型",
    "admin.visitsClient": "浏览器 / 系统",
    "admin.visitsReferer": "来源",
    "admin.visitsUaHint": "原始 UA",
    "admin.visitsTime": "时间",
    "admin.visitsTotal": "共 {count} 条",
    "admin.visitsLoadMore": "加载更多",
    "admin.visitsFootnote": "地区为 IP 地理与 Vercel 国家码估算；设备与浏览器由 UA 解析，仅供参考。",
  ...
  en: {
    ...
    "admin.visitsDevice": "Device / model",
    "admin.visitsClient": "Browser / OS",
    "admin.visitsReferer": "Referer",
    "admin.visitsUaHint": "Raw UA",
    "admin.visitsTime": "Time",
    "admin.visitsTotal": "{count} entries",
    "admin.visitsLoadMore": "Load more",
    "admin.visitsFootnote": "Location is approximate (IP / Vercel). Device and browser are parsed from the user-agent string.",
  ...
  fr: {
    ...
    "admin.visitsDevice": "Appareil / modèle",
    "admin.visitsClient": "Navigateur / OS",
    "admin.visitsReferer": "Référent",
    "admin.visitsUaHint": "UA brut",
    "admin.visitsTime": "Heure",
    "admin.visitsTotal": "{count} entrées",
    "admin.visitsLoadMore": "Charger plus",
    "admin.visitsFootnote": "Lieu approximatif (IP / Vercel). Appareil et navigateur issus du user-agent.",
